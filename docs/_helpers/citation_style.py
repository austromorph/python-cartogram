...
"""Modify sphinxcontrib.bibtex so that the reference style is closer to what’s used in geography."""
...
__all__ = ["CITATION_STYLE", "REFERENCE_STYLE"]


# Define (custom) names for the styles we create below
CITATION_STYLE = "apa7_with_doi_for_misc"
REFERENCE_STYLE = "author_year_apa7_full_link"
...
pybtex.plugin.register_plugin(
    "pybtex.style.formatting", CITATION_STYLE, ApaMiscDoiStyle
)
